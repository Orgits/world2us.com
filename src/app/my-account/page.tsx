                        ...
                        <div className="left md:w-1/3 w-full xl:pr-[3.125rem] lg:pr-[28px] md:pr-[16px]">
                            <div className="user-infor bg-surface lg:px-7 px-4 lg:py-10 py-5 md:rounded-[20px] rounded-xl">
                                <div className="heading flex flex-col items-center justify-center">
                                    ...
                                    <div className="mail heading6 font-normal normal-case text-secondary text-center mt-1">contact@world2us.com</div>
                                </div>
                                ...
                                <form>
                                    ...
                                    <div className='grid sm:grid-cols-2 gap-4 gap-y-5 mt-5'>
                                        ...
                                        <div className="email">
                                            ...
                                            <input className="border-line mt-2 px-4 py-3 w-full rounded-lg" id="email" type="email" defaultValue={'contact@world2us.com'} placeholder="Email address" required />
                                        </div>
                    ...
                    <div className="info p-10 border-r border-line">
                        ...
                        <div className="list_info grid grid-cols-2 gap-10 gap-y-8 mt-5">
                            <div className="info_item">
                                ...
                                <h6 className="heading6 normal-case order_email mt-2">contact@world2us.com</h6>
                            </div>
                            <div className="info_item">

                    ...
                    <div className="container">
                        <div className="content-footer py-[60px] flex justify-between flex-wrap gap-y-8">
                            <div className="company-infor basis-1/4 max-lg:basis-full pr-7">
                                ...
                                <div className='flex gap-3 mt-3'>
                                    ...
                                    <div className="flex flex-col ">
                                        <span className=''>contact@world2us.com</span>
                                        <span className='mt-3'>+91 63634 06885</span>
                                        <span className='mt-3 pt-px'>1071 A, Maruti Vihar, Gurugram, Gurugram, Haryana, 122002</span>
                                    </div>
                                </div>
                            </div>
                            <div className="right-content flex flex-wrap gap-y-8 basis-3/4 max-lg:basis-full">
                                <div className="list-nav flex justify-between basis-2/3 max-md:basis-full gap-4">
                                    <div className="item flex flex-col basis-1/3 ">
                                        <div className="text-button-uppercase pb-3">Infomatio</div>
                        ...
                        <div className="footer-bottom py-3 flex items-center justify-between gap-5 max-lg:justify-center max-lg:flex-col border-t border-line">
                            <div className="left flex items-center gap-8">
                                <div className="copyright caption1 text-secondary">©2023 World2us. All Rights Reserved.</div>
